...
export default async function(req:Request) {
  ...
  try {
    ...
    await admitEcosystemOperation(base44, { sourceApp:'LOKIN AI', domain:'provider', type:'provider_request', operation:'recraft_vector_provider', priority:65, estimatedMs:5000, realtime:false, background:false, tags:['provider'] });
