  ...
  return (
    <main className="min-h-screen bg-background text-foreground px-5 py-10">
      <div className="mx-auto max-w-xl space-y-5">
        <div className="lokin-kicker lokin-kicker-lime">HELP</div>
        ...
        {sent ? (
          ...
          <form onSubmit={submit} className="space-y-3 rounded-3xl border border-white/10 lokin-panel lokin-card p-4">
