...
import { LokinEmblemImg, LOKIN_HERO_LOCK_V5, LOKIN_HEADER_LOCKUP_V2 } from "@/components/Brand";
      ...
      {working ? (
        ...
        <button onClick={resumeWork} className="w-full flex-1 min-h-0 flex flex-col items-center active:scale-[.99] transition-transform">
          <span className="flex-1 min-h-0 w-full flex items-center justify-center">
            <img src={LOKIN_HERO_LOCK_V5} alt="LOKIN emblem" draggable="false" className="max-h-full w-auto max-w-[88%] object-contain" />
          </span>
