...
const PALETTE = [
  { name: "LOKIN Green™", hex: "#8FE44E", text: "text-black" },
...
const VALUES = [
  { icon: Route, title: "Route AI", desc: "Ranks and sequences offers by your selected earning strategy using the offer data available to LOKIN." },
...
export default function Brand() {
  return (
    <div className="p-4 space-y-6 pb-8">
        ...
        <div className="grid grid-cols-3 gap-2">
          {PALETTE.map((c) => (
            <div key={c.name} className="rounded-xl overflow-hidden border border-white/10">
              <div className="h-12 flex items-center justify-center text-[10px] font-bold" style={{ background: c.hex, color: c.hex === "#000000" ? "#8FE44E" : undefined }}>
      ...
      {/* Consolidated admin-only order + fulfillment intelligence */}
